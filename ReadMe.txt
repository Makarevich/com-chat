This chat is a client/server application with the server implemented as a COM out-of-process server. That means that after that projects are built you have to REGISTER the COM server and the proxy/stub dll.
